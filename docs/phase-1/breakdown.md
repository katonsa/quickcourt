...
| P1-03 | Database, Prisma, Migration Foundation     |       P0 | Ready  | P1-01, P1-02               | [03-database-prisma-migration-foundation.md](./tasks/03-database-prisma-migration-foundation.md)       | PostgreSQL + Prisma ready, schema applied, constraints verified, migration discipline documented   | Migration verification, DB smoke test     |
