...
- P1-06 Slice 0 is in progress with canonical auth UI routes documented as `/sign-in` and `/sign-up`; `/login` and `/register` are documented as redirect aliases for the upcoming auth route implementation.
