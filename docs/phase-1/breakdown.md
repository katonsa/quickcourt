...
| P1-07 | Testing & CI Harness                       |       P0 | Todo   | P1-01, P1-02, P1-03        | [07-testing-ci-foundation.md](./tasks/07-testing-ci-foundation.md)                                     | Vitest, unit test scripts, required DB integration harness, CI pipeline                            | CI passes typecheck/lint/unit/integration |
