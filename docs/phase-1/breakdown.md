...
| P1-06 | Auth UI & Shell Layouts                    |       P0 | Ready       | P1-04, P1-05               | [06-auth-ui-and-shell-layouts.md](./tasks/06-auth-ui-and-shell-layouts.md)                             | Auth pages, dashboard shells, forbidden/unauthorized/error UI                                      | Component/page smoke tests where feasible |
